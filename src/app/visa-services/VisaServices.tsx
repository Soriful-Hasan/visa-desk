...
export default function VisaServices() {
  ...
  // Fetch visa services on component mount
  useEffect(()=>{
  ...
  return (
 <section id="our-service" className="py-20 px-6 bg-gray-50 transition-colors duration-300">
  <div className="container mx-auto max-w-7xl">
    {/* Header */}
    <div className="text-center mb-16">
      <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
        Our <span className="text-blue-600">Visa Services</span>
      </h2>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-800"
          value={search}
        ...
        >
          ...
          <div className="p-8">
            ...
            <div className="flex items-center justify-between pt-6 border-t border-gray-100">
              ...
              <button className="flex items-center text-blue-600 hover:text-blue-800 font-semibold group-hover:translate-x-1 transition-all duration-200">
                Apply Now
