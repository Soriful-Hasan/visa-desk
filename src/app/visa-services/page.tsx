        ...
        <div className="text-center mb-16">
          ...
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
              value={search}
