...
const ApplicantForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-30 bg-gray-50  px-4">
  <div className="max-w-7xl mx-auto">
    <div className="text-center mb-8">
      <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
        My <span className="text-blue-600">Application</span>
      </h2>
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-sm font-medium text-blue-600">{completedSteps}/4 completed</span>
      </div>
          ...
          <div key={step.key} className="flex items-center space-x-3">
            ...
            <span
              className={`text-sm font-medium ${
                progress[step.key as keyof Progress] ? "text-green-600" : "text-gray-600"
              }`}
            >
              {step.label}
            </span>
      ...
      <div className="space-y-6">
          ...
          <Controller
            ...
            render={({ field }) => (
              <input
                {...field}
                type="text"
                className="w-full border-blue-500 px-3 py-2 text-black border rounded-lg"
          ...
          <Controller
            ...
            render={({ field }) => (
              <input
                {...field}
                type="text"
                className="w-full border-blue-500 text-black px-3 py-2 border rounded-lg"
        ...
        <div>
          ...
          <Controller
            ...
            render={({ field }) => (
              <select {...field} className="w-full text-black px-3   py-2 border border-blue-500 rounded-lg">
        ...
        <div>
          <button
            ...
            className="w-full cursor-pointer px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
          >
            {isSubmitting ? "Saving..." : "Save Application"}
          </button>
          {isDirty && <p className="text-center text-sm text-gray-500 mt-2">You have unsaved changes</p>}
        </div>
      </div>
    </form>
  </div>
